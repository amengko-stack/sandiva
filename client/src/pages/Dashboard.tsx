      ...
      <main className="main-content">
        ...
        <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/upload" data-testid="button-upload-header" className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-md font-medium" style={{ background: "hsl(var(--primary))", color: "hsl(var(--primary-foreground))" }}>
      ...
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            <Link href={`/group/${group.id}`} data-testid={`link-group-${group.id}`} className="text-xs text-primary hover:underline">Details →</Link>
          </div>
        </div>
        {s && (
