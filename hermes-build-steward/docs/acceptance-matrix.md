...
| AC-17 | Strict normalized result validation, unique evidence identities, exact criterion resolution, origin/kind enforcement and consistent dispositions | LOCAL PASS |
| AC-18 | Coordinator-owned immutable GitHub commit/check retrieval produces task-bound trusted-external CI evidence | LOCAL PASS; live evidence VM PENDING |
...
| AC-A6 | malformed/oversized results, dangling/duplicate/cross-criterion references, forged CI origins and job-supplied semantic evidence rejected before mutation | LOCAL PASS |
