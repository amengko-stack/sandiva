...
// LDD Stage 1 registers user-selected entity roots. Keep that existing discovery
// behavior separate from Litigation's server-issued immutable-session boundary.
