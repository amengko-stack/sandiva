...
export function MattersScreen({ matters, partners }: { matters: Matter[]; partners: Partner[] }) {
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="text-left text-[10.5px] uppercase tracking-wider text-[var(--text-3)]">
                ...
                <th className="px-2 py-2.5">Engagement partner</th><th className="px-2 py-2.5">Status</th><th className="px-2 py-2.5" />
              </tr>
            </thead>
            <tbody>
              {matters.map((m) => (
